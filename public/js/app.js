...
function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', pizza).then(function (res) {
    ...
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      type: 'success',
      timeout: 1000,
      text: 'item added to cart' //progressBar : false,
    ...
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      type: 'error',
      timeout: 1000,
      text: 'something went wrong' //progressBar : false,
      //layout: bottomleft,topleft....  
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkonlinepizza"] = self["webpackChunkonlinepizza"] || [];
